...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="Llama-3.2-1B-Instruct_math_es_experiment_ours" \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=30 \
    trainer.test_freq=10 \
    trainer.total_epochs=500 2>&1 | tee es_experiment_math_ours.log $@
