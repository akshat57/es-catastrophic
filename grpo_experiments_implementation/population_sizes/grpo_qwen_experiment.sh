...
ray start --head --num-gpus=2 --port=6386
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="Qwen2.5-1.5B-Instruct_es_experiment_countdown_rollout_8" \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=30 \
    trainer.test_freq=10 \
    trainer.total_epochs=500 2>&1 | tee es_experiment_suggested.log $@